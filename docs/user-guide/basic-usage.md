...
Android 10+ requires that a foreground service is running otherwise capturing won't work, follow [this solution](/docs/installation/android#screen-capture-support---android-10).  
...
If you want to improve call reliability then check [this guide](/docs/user-guide/call-reliability).  
